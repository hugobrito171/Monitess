...
[`MONITESS_ALWAYS_SHOW_PERCENTAGES`](./configuration/basic#monitess_always_show_percentages) for that.
...
manually, using the [`MONITESS_USE_NETWORK_INTERFACE`](./configuration/network#monitess_use_network_interface) flag.
...
## Can you use monitess. without mounting the whole host drive?
...
please create a [new Issue on GitHub](https://github.com/hugobrito171/Monitess/issues).
