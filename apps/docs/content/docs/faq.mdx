...
[`DASHDOT_ALWAYS_SHOW_PERCENTAGES`](./configuration/basic#monitess_always_show_percentages) for that.
...
manually, using the [`DASHDOT_USE_NETWORK_INTERFACE`](./configuration/network#monitess_use_network_interface) flag.
