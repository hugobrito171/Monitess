...
### `MONITESS_FS_DEVICE_FILTER`

To hide specific drives, you can pass the device names as a string list using this parameter.
If you don't know the device names of your drives, have a look at the log of monitess. and look for the `Static Server Info -> storage` output.
...
### `MONITESS_FS_TYPE_FILTER`

If monitess. detects network drives as internal drives, you can provide a list of ignored FS types here.
Please also create a [bug ticket](https://github.com/hugobrito171/Monitess/issues/new/choose) on the
...
### `MONITESS_STORAGE_WIDGET_ITEMS_PER_PAGE`
...
### `MONITESS_STORAGE_WIDGET_MIN_WIDTH`
...
### `MONITESS_STORAGE_POLL_INTERVAL`
...
### `MONITESS_OVERRIDE_STORAGE_BRANDS`
...
### `MONITESS_OVERRIDE_STORAGE_SIZES`
...
### `MONITESS_OVERRIDE_STORAGE_TYPES`
