...
### `MONITESS_USE_NETWORK_INTERFACE`

If monitess. detects the wrong gateway as your default interface, you can provide a name here that is used instead.

- type: `string`
- default: `unset`

### `MONITESS_SPEED_TEST_FROM_PATH`

You can provide a local file-path from where monitess. should read its speed-test results.
...
If you are running monitess. using Docker, you will have to prepend your file path with `/mnt/host`
</Callout>

- type: `string`
- default: `unset`

### `MONITESS_NETWORK_SPEED_AS_BYTES`
...
| `false`                                                                                                                        | `true`                                                                                                                           |
| ------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------- |
 | ![Network widget with speed in bits per second](/img/network_bits_per_second.png) | ![Network widget with speed in bytes per second](/img/network_bytes_per_second.png) |

## Styles

### `MONITESS_SPEED_TEST_INTERVAL`
...
### `MONITESS_SPEED_TEST_INTERVAL_CRON`

At which interval the network speed-test should be rerun, passed as a cron string.
This setting overrides `MONITESS_SPEED_TEST_INTERVAL` if set.
...
### `MONITESS_NETWORK_WIDGET_MIN_WIDTH`
...
### `MONITESS_NETWORK_SHOWN_DATAPOINTS`
...
### `MONITESS_NETWORK_POLL_INTERVAL`
...
if you want to use monitess on a VPS or a system where the data cannot be
gathered automatically.

### `MONITESS_OVERRIDE_NETWORK_TYPE`

- type: `string`
- default: `unset`

### `MONITESS_OVERRIDE_NETWORK_SPEED_UP`
...
### `MONITESS_OVERRIDE_NETWORK_SPEED_DOWN`
...
### `MONITESS_OVERRIDE_NETWORK_INTERFACE_SPEED`
...
### `MONITESS_OVERRIDE_NETWORK_PUBLIC_IP`
