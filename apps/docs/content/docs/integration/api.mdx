---
title: API Endpoints
description: Query information about the monitess. installation
tags:
  - Integration
---
...
There are two endpoints which can be used to retrieve data about the running monitess. instance:
