---
title: From Source
description: How to install and configure monitess. from source
tags:
  - Installation
  - Configuration
  - Source
...
- [speedtest](https://www.speedtest.net/apps/cli) (recommended)
  ...
  - or alternatively: [use local file](../configuration/network#monitess_speed_test_from_path)
</Step>
<Step>
## Setup
...
When done, you can run the Monitessboard by executing:
...
before being able to start your Monitessboard.
...
You can update your Monitess instance, by stopping your instance, then
